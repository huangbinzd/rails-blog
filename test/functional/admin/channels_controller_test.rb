...
class Admin::ChannelsControllerTest < ActionController::TestCase
  ...
  test "should create admin_channel" do
    assert_difference('Admin::Channel.count') do
      post :create, admin_channel: { pid: @admin_channel.pid, sort: @admin_channel.sort, status: @admin_channel.status, target: @admin_channel.target, title: @admin_channel.title, url: @admin_channel.url }
    end
  ...
  test "should update admin_channel" do
    put :update, id: @admin_channel, admin_channel: { pid: @admin_channel.pid, sort: @admin_channel.sort, status: @admin_channel.status, target: @admin_channel.target, title: @admin_channel.title, url: @admin_channel.url }
    assert_redirected_to admin_channel_path(assigns(:admin_channel))
  end
